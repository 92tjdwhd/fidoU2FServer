 ...
 * persist this.
 */
finishRegistration = (challenge, deviceResponse) =>{
 ...
 * the server.
 */
startAuthentication = (appId, deviceRegistration) =>{
  var challenge = generateChallenge();
  return {
    version: U2F_VERSION,
    appId: appId,
 ...
 */
finishAuthentication = (challenge, deviceResponse, deviceRegistration) => {
  // Validation
